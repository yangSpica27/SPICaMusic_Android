...
class PlayHistoryRepository(
     ...
     */
    @WorkerThread
    fun getSongPlayCount(mediaId: Long): Long = playHistoryDao.getPlayCount(mediaId)

    /**
     * 获取上次播放时间
     */
    @WorkerThread
    fun getLastPlayTime(mediaId: Long): Long = playHistoryDao.getLasePlayHistory(mediaId)?.time ?: 0L
