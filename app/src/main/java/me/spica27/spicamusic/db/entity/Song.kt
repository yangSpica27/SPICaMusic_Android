...
data class Song(
    ...
    fun getCoverUri(): Uri = albumId.toCoverUri()

    fun getSongUri(): Uri = mediaStoreId.toAudioUri()
    ...
    override fun toString(): String =
        "Song(songId=$songId, mediaStoreId=$mediaStoreId, path='$path', displayName='$displayName', artist='$artist', size=$size, like=$like, duration=$duration, sort=$sort)"
