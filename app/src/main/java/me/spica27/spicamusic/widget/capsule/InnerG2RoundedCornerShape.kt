 ...
 */
@Stable
fun G2RoundedCornerShape.inner(innerPadding: Dp): G2RoundedCornerShape = InnerG2RoundedCornerShape(this, innerPadding)
...
private data class InnerCornerSize(
    ...
    override fun toPx(
        shapeSize: Size,
        density: Density,
    ): Float = outerCornerSize.toPx(shapeSize, density) - with(density) { innerPadding.toPx() }
}
