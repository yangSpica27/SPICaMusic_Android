...
class ServiceCallback(
    ...
    override fun onCustomCommand(
        ...
        val action =
            customCommand.toCustomCommendOrNull()
    ...
    private fun resolveMediaItems(mediaItems: List<MediaItem>): List<MediaItem> =
        mediaItems.mapNotNull { item -> MediaLibrary.getItem(item.mediaId) }
    ...
    override fun onGetItem(
        ...
        Futures.submitAsync<LibraryResult<MediaItem>>({
    ...
    override fun onPlaybackResumption(
        ...
        Futures.submitAsync({
            val historyItems =
                playerKVUtils.getHistoryItems().map {
                    it.toMediaItem()
                }
            Futures.immediateFuture(
