...
class VisualizerDrawableManager {
    ...
    companion object {
        private val visualiserDrawables =
            hashMapOf<VisualiserType, VisualiserDrawable>(
    ...
    fun getVisualiserDrawable(): VisualiserDrawable =
        visualiserDrawables[currentVisualiserType]
