...
public final class FlacExtractor implements Extractor {
  ...
  private void decodeStreamMetadata(ExtractorInput input) throws IOException {
    ...
    if (this.streamMetadata == null) {
      ...
      outputFrameHolder = new FlacBinarySearchSeeker.OutputFrameHolder(ByteBuffer.wrap(outputBuffer.getData()));
      binarySearchSeeker =
          outputSeekMap(
              flacDecoderJni,
              streamMetadata,
  ...
  private int handlePendingSeek(
      ...
      FlacBinarySearchSeeker.OutputFrameHolder outputFrameHolder,
